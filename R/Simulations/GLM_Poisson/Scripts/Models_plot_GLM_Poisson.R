...
# Different scenarios
beta1_curr <- c(
  0.50, 0.53, 0.54, 0.55, 0.57, 0.58, 0.59,
...
ggsave(
  filename = "GLM_Poisson_comp.pdf", path = "Plots", plot = GLM_Poisson_comp,
...
ggsave(
  filename = "sd_GLM_Poisson.pdf", path = "Plots", plot = standard_dev_plot,
...
df_long_mean <- pivot_longer(mean_data,
  cols = c(
    NPP_unif, NPP_cbf,
    RMAP, SAM
  ),
...
ggsave(
  filename = "mean_GLM_Poisson.pdf", path = "Plots", plot = mean_plot,
  width = 15, height = 10, device = "pdf", dpi = 500, useDingbats = FALSE
)
...
plot_comb_beta <- ggarrange(standard_dev_plot, mean_plot,
  ncol = 2, nrow = 1,
  common.legend = TRUE
)
plot_comb_beta <- annotate_figure(plot_comb_beta,
...
ggsave(
  filename = "combined_plot_GLM_Poisson.pdf", path = "Plots", plot = plot_comb_beta,
  width = 15, height = 10, device = "pdf", dpi = 500, useDingbats = FALSE
)
...
ggsave(
  filename = "GLM_poisson_delta_plot.pdf", path = "Plots", plot = GLM_poisson_delta_plot,
  width = 15, height = 8, device = "pdf", dpi = 500, useDingbats = FALSE
)
